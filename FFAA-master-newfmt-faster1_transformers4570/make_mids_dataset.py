...
def main(args: argparse.Namespace) -> None:
    ...
    if args.which_part != 0:
        ...
        fname = fname.split('.')[0]
        out_path = os.path.join(head, f"{fname}_{args.which_part}.json")
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--model_path", type=str, default="checkpoints/effaa-llava-mistral-7b-lora_2",
                   help="Path to vLLM.")
    ...
    p.add_argument("--input_json", type=str, default="/datasets/newout/mids_train.json",
    ...
    p.add_argument("--output_json", type=str, default="/datasets/newout/mids.json",
    ...
    p.add_argument("--num_workers", type=int, default=4, help="DataLoader workers for image I/O.")
