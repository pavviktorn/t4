...
deepspeed --master_port 25642 --include localhost:1,2,3,4,5,6,7 \
    llava/train/train_mem.py \
    --lora_enable True --lora_r 32 --lora_alpha 48 --mm_projector_lr 2e-5 \
    --deepspeed ./scripts/zero3.json \
    --model_name_or_path ./checkpoints/ffaa-mistral-7b \
    --version v1 \
    --data_path /datasets/newout/eFFAA_dataset.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/effaa-llava-mistral-7b-lora \
    --num_train_epochs 3 \
