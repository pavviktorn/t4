...
Base_vLLM_path="/datasets/work/vLLM/FFAA-master-newfmt/checkpoints_4+13fmt_fix/effaa-llava-mistral-7b-lora_1"
Finetuned_vLLM_path="/datasets/work/vLLM/FFAA-master-newfmt/checkpoints_4+5fmt/effaa-llava-mistral-7b-lora"
Merged_vLLM_path="/datasets/work/vLLM/FFAA-master-newfmt/checkpoints_4+5fmt/effaa-llava-mistral-7b-lora_0"
...
# init_mids="/datasets/work/vLLM/FFAA-master-newfmt/checkpoints_4+13fmt_fix/effaa-llava-mistral-7b-lora_1/mids.pth"
init_mids="/datasets/work/vLLM/FFAA-master-newfmt/checkpoints_4+5fmt/effaa-llava-mistral-7b-lora_0/mids.pth"
...
image_dir3="/datasets/work/vLLM/data/fmt_error11/miss_unidata"
output_json3="/datasets/newout/vqa_info_2+13+4+3_fmt/temp_fix/mids_dir_err4.json"
...
run_parts "python3.12 make_mids_dataset_from_folder_batch.py \
    --model_path $Merged_vLLM_path --batch_size 140" 7
